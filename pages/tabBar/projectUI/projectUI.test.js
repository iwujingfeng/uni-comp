describe('pages/tabBar/projectUI/projectUI.nvue', () => {
    let page
    beforeAll(async () => {
        // 重新reLaunch至首页，并获取首页page对象（其中 program 是uni-automator自动注入的全局对象）
        page = await program.reLaunch('/pages/tabBar/projectUI/projectUI')
    ...
    it('.uni-panel action', async () => {
      ...
      expect((await program.navigateBack()).path).toBe('pages/tabBar/projectUI/projectUI')
    })
})
