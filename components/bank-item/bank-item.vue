...
<script>
	// 官方文档：https://ext.dcloud.net.cn/plugin?id=2151
	export default {
		name: 'bankItem',
		props: {
			/*
			 * bankCode(String) —— 银行代码(例：ABC)。
			 * bankName(String) —— 银行名称(例：中国农业银行)。
			 * cardType(String) —— 银行卡类型(例：储蓄卡)。
			 * cardCode(String) —— 银行卡卡号(例：5106365986893)。
			 */
			bankCode: {
				type: String,
				required: true
