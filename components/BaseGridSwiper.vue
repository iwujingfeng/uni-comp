...
<script>
	import QSGrid from './BaseGridSwiperItem.vue'
	// #ifdef APP-NVUE
	...
	export default {
		...
		methods: {
			...
			_click({index,ID}, pageNum) {
				console.log('22222',index,ID, pageNum)
				let count;
				...
				this.$emit('gridClick', count,index,ID)
			}
		}
	}
</script>
...
<style scoped>
	/* #ifndef APP-NVUE */
	@import url("box-sizing-border-box.css");
